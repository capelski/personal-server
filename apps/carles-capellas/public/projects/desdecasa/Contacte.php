...
<title>Contacta'ns - DesdeCasa</title>
...
<body><div id="mainbg">
		...
		<table width="100%" border="0">
		  <tr>
		    <td colspan="3"><p><font color="#FFFFFF" size="3" face="Karla">Si vols contactar amb nosaltres omple el següent formulari i et contestarem tant aviat com sigui possible. Gràcies per la teva paciència!</font></p>
	        <p>&nbsp;</p><p>&nbsp;</p></td>
	      </tr>
		  <tr>
		    <td width="11%"><p>&nbsp;</p>
	        <p>&nbsp;</p></td>
		    <td width="59%"><form id="form1" method="post" action="ContacteAccio.php">
		      <p>&nbsp;</p>
		      <table width="100%" border="0">
		        <tr>
		        ...
		        <tr>
		          <td><font color="#FFFFFF" size="3" face="Karla">Correu electrònic:</font></td>
		        ...
		        <tr>
		          <td colspan="2" align="center"><input type="submit" name="button" id="button" onclick="MM_validateForm('nom','','R','correu','','RisEmail','comentari','','R');return document.MM_returnValue" value="Enviar" /></td>
	            </tr>
	          </table>
	        </form></td>
		    <td width="30%"><img src="imatges/Contacta.gif" alt="" width="160" height="184" /></td>
	      </tr>
		  </table>
