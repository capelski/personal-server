...
<body onLoad="seleccionar();"><div id="mainbg">
	...
	<input type="submit"  name="button" onClick="selectday()"   id="button" value="  Mostra per Dia  " style="border:#666 solid 1px; background-color:#FFF; border-radius:3px " />
		...
		<img src="../imatges/dte.png" alt="" width="328" height="17" />    
		<input type="submit"  name="button"  onclick="window.location.href='LocalsAlf.php'" id="button" value="Mostra'ls tots alfabèticament" style="border:#666 solid 1px; background-color:#FFF; border-radius:3px " />
		<input type="submit"  name="button" disabled="true"  id="button" value="Mostra'ls tots per descomptes" style="border:#666 solid 1px; background-color:#FFF; border-radius:3px " />
