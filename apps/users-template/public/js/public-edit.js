	...
	function createPageLoad() {
		actionButton.on('click', function() {
			...
			.then(function (element) {
				document.location.href = '/users-template/public/details?id=' + element.id;
			})
		...
		window.application.authentication.subscribe(function(user) {
			...
			if (user && window.application.userHasPermission(user, 'public:create')) {
		...
		window.application.authentication.pageLoad(['public:create']);
	}
