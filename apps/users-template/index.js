...
var elementsSecurity = require('./controllers/elements-security');
...
router.get('/api/elements/getById', elementsSecurity.allowedElementMiddleware('api'), elementsApi.getById);

router.get('/', elementsViews.list);
router.get('/list', elementsViews.list);
// router.get('/details', elementsViews.details);
router.get('/details', elementsSecurity.allowedElementMiddleware('view'), elementsViews.details);
